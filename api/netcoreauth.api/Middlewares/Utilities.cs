...
namespace netcoreauth.api
{
    ...
    {        
        ...
        public static dynamic GenerateTokens(User user, IConfiguration _config)
        {
            ...
            //         var accessJwt = new JwtSecurityToken(issuer: "http://localhost:4999/", audience: "http://localhost:4999/", claims: GetTokenClaims(email, now), notBefore: now, expires: now.Add(Startup.userTokenOptions.AccessExpiration), signingCredentials: Startup.userTokenOptions.SigningCredentials);
            ...
            //         return result;
            var securityKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("MySuperSecureKey"));
